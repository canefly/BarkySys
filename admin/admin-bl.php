    ...
    <?php while ($row = mysqli_fetch_assoc($result)) { ?>
      <div class="booking-card">
        <?php if (!empty($row['service_image'])) { 
          // Build the correct relative path to uploads folder
          $relativeImagePath = '../' . ltrim($row['service_image'], '/'); 
        ?>
          <img src="<?php echo $relativeImagePath; ?>" alt="Service Image" class="service-img">
        <?php } ?>
